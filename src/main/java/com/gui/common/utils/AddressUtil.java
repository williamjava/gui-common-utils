...
public class AddressUtil {
    private static String secretId = "AKID5wqn2tRoFamnQsR65UoTKHtCUmrcs48YJ07m";
    private static String secretKey = "4OsZtx4bNf9K7z41v73SijNsI9l8SB9ivi8yXhf4";
    ...
    public static  String getResult(String address) throws NoSuchAlgorithmException, UnsupportedEncodingException, InvalidKeyException {
