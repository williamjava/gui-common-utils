...
//        }
    ...
    public Map<String, String> oldFacePay(Map<String, String> reqData) throws Exception {
        String url=WXPayConstants.FACE_OLD_SUFFIX;

        String respXml = this.requestWithoutCert(url, this.fillRequestData(reqData), config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
        return this.processResponseXml(respXml);
    }
